window.addEventListener("load", function () {
    var game_width = 640;
    var game_height = 260;
    var gameLive = true; // Fixed typo here
    var level = 1;
    var life = 5;
    var color = "white"; // Initialize color variable with a valid color
    ...
    var update = function () {
        ...
        if (checkCollision(player, goal)) {
            ...
            for (var a = 0; a < enemies.length; a++) { // Fixed loop condition here
